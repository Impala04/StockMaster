...
import { LayoutDashboard, Box, ArrowLeftRight, Truck, Settings, LogOut, X } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  const navItems = [
    ...
    { id: ViewState.RECEIPTS, label: 'Receipts', icon: Truck },
      ...
      >
        ...
        <div className="h-16 flex items-center px-6 border-b border-border justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg tracking-tight text-text">Nexus IMS</span>
          </div>
